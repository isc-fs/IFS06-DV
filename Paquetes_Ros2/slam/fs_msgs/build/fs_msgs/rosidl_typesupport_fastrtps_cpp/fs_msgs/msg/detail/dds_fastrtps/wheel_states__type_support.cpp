...
#include "fs_msgs/msg/detail/wheel_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fs_msgs::msg::WheelStates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fs_msgs::msg::WheelStates & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs::msg::WheelStates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fs_msgs::msg::WheelStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fs_msgs::msg::WheelStates *>(
    untyped_ros_message);
...
{
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_WheelStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, msg, WheelStates)() {
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_WheelStates__handle;
}
