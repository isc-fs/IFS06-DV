...
#include "fs_msgs/msg/detail/extra_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: laps
  {
    ...
    size_t item_size = sizeof(ros_message.laps[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs::msg::ExtraInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fs_msgs::msg::ExtraInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fs_msgs::msg::ExtraInfo *>(
    untyped_ros_message);
...
{
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_ExtraInfo__handle;
}
