...
{
  new (message_memory) fs_msgs::msg::Cone(_init);
}

void Cone_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fs_msgs::msg::Cone *>(message_memory);
  typed_message->~Cone();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Cone_message_member_array[2] = {
  {
    ...
    offsetof(fs_msgs::msg::Cone, location),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fs_msgs::msg::Cone, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::fs_msgs::msg::rosidl_typesupport_introspection_cpp::Cone_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fs_msgs, msg, Cone)() {
  return &::fs_msgs::msg::rosidl_typesupport_introspection_cpp::Cone_message_type_support_handle;
}
