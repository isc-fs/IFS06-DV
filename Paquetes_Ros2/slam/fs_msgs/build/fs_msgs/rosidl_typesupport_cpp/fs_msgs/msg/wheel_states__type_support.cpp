...
static const _WheelStates_type_support_symbol_names_t _WheelStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, msg, WheelStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fs_msgs, msg, WheelStates)),
  }
};
...
get_message_type_support_handle<fs_msgs::msg::WheelStates>()
{
  return &::fs_msgs::msg::rosidl_typesupport_cpp::WheelStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fs_msgs, msg, WheelStates)() {
  return get_message_type_support_handle<fs_msgs::msg::WheelStates>();
}
