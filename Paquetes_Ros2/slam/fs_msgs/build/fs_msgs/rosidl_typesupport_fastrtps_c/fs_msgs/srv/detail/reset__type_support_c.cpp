...
#include "fs_msgs/srv/detail/reset__rosidl_typesupport_fastrtps_c.h"
...
using _Reset_Request__ros_msg_type = fs_msgs__srv__Reset_Request;
...
size_t get_serialized_size_fs_msgs__srv__Reset_Request(
  const void * untyped_ros_message,
...
static uint32_t _Reset_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fs_msgs__srv__Reset_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fs_msgs
size_t max_serialized_size_fs_msgs__srv__Reset_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs__srv__Reset_Request;
    is_plain =
      (
...
static size_t _Reset_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fs_msgs__srv__Reset_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fs_msgs, srv, Reset_Request)() {
...
using _Reset_Response__ros_msg_type = fs_msgs__srv__Reset_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fs_msgs
size_t get_serialized_size_fs_msgs__srv__Reset_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Reset_Response__ros_msg_type * ros_message = static_cast<const _Reset_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fs_msgs__srv__Reset_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fs_msgs
size_t max_serialized_size_fs_msgs__srv__Reset_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fs_msgs__srv__Reset_Response;
    is_plain =
      (
...
static size_t _Reset_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fs_msgs__srv__Reset_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fs_msgs, srv, Reset_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fs_msgs, srv, Reset)() {
