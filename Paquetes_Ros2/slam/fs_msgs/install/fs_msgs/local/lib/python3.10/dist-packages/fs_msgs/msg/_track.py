...
class Track(metaclass=Metaclass_Track):
    ...
    _fields_and_field_types = {
        'track': 'sequence<fs_msgs/Cone>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['fs_msgs', 'msg'], 'Cone')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'track' field must be a set or sequence and each value of type 'Cone'"
        self._track = value
