...
#include "fs_msgs/msg/detail/cone__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fs_msgs::msg::Cone & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs::msg::Cone;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fs_msgs::msg::Cone *>(
    untyped_ros_message);
...
{
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, msg, Cone)() {
  return &fs_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
