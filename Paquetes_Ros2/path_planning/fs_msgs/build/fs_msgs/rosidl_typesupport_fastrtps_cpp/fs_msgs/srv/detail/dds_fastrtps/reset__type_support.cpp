...
#include "fs_msgs/srv/detail/reset__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fs_msgs::srv::Reset_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: wait_on_last_task
  cdr << (ros_message.wait_on_last_task ? true : false);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fs_msgs::srv::Reset_Request & ros_message)
{
  // Member: wait_on_last_task
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.wait_on_last_task = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: wait_on_last_task
  {
    size_t item_size = sizeof(ros_message.wait_on_last_task);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs::srv::Reset_Request;
    is_plain =
      (
      offsetof(DataType, wait_on_last_task) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const fs_msgs::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fs_msgs::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  return &fs_msgs::srv::typesupport_fastrtps_cpp::_Reset_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, srv, Reset_Request)() {
  return &fs_msgs::srv::typesupport_fastrtps_cpp::_Reset_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fs_msgs
cdr_serialize(
  const fs_msgs::srv::Reset_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fs_msgs::srv::Reset_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fs_msgs::srv::Reset_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fs_msgs::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fs_msgs::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &fs_msgs::srv::typesupport_fastrtps_cpp::_Reset_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, srv, Reset_Response)() {
  return &fs_msgs::srv::typesupport_fastrtps_cpp::_Reset_Response__handle;
}
...
{
  return &fs_msgs::srv::typesupport_fastrtps_cpp::_Reset__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fs_msgs, srv, Reset)() {
  return &fs_msgs::srv::typesupport_fastrtps_cpp::_Reset__handle;
}
