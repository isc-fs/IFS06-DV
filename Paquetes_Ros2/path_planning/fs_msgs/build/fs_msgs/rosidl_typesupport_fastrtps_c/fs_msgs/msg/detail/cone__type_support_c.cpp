...
#include "fs_msgs/msg/detail/cone__rosidl_typesupport_fastrtps_c.h"
...
using _Cone__ros_msg_type = fs_msgs__msg__Cone;
...
static uint32_t _Cone__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fs_msgs__msg__Cone(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fs_msgs__msg__Cone;
    is_plain =
      (
...
static size_t _Cone__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fs_msgs__msg__Cone(
